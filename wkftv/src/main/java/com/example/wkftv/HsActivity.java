...
public class HsActivity extends AppCompatActivity {
        ...
        public void run() {
            ...
            if(isStart) {
                ...
                if(i %9==0 && i!=dataBeans.size()-1){
                   ...
                   FunctionAdapter functionAdapter=new FunctionAdapter(getPageList(),HsActivity.this);
        ...
        data.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                   ...
                   FunctionAdapter functionAdapter=new FunctionAdapter(dataBeans,HsActivity.this);
                    recyclerView.setLayoutManager(new LinearLayoutManager(HsActivity.this));
    ...
    class FunctionAdapter extends RecyclerView.Adapter<FunctionAdapter.VH>{
        ItemHsBinding binding;
        @NonNull
        @Override
        public FunctionAdapter.VH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            binding= DataBindingUtil.inflate(LayoutInflater.from(viewGroup.getContext()),R.layout.item_hs,viewGroup,false);
